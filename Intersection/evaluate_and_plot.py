"""
Evaluation and plotting script for intersection-v0 DRL models
...
def plot_learning_curve(training_data_path, save_path, title):
    ...
    # episode_rewards = episode_rewards[:20000]  # Limit to first 10,000 episodess
...
def main():
    ...
    print("=" * 60)
    print("intersection-v0 Model Evaluation and Plotting")
    print("=" * 60)
    ...
    if os.path.exists("models/intersection_lidar.zip") and os.path.exists("training_data/intersection_lidar_training.json"):
        # Plot learning curve
        print("\n1. Generating learning curve...")
        plot_learning_curve(
            "training_data/intersection_lidar_training.json",
            "plots/intersection_lidar_learning_curve.png",
            "intersection-v0 Learning Curve (LidarObservation)"
        )
        
        # Evaluate model
        print("\n2. Evaluating trained model...")
        model_lidar = PPO.load("models/intersection_lidar")
        eval_rewards_lidar = evaluate_model(model_lidar, create_intersection_env_lidar, n_episodes=100)
        
        # Save evaluation data
        with open("evaluation_data/intersection_lidar_eval.json", 'w') as f:
            json.dump({
        ...
        plot_violin_performance(
            eval_rewards_lidar,
            "plots/intersection_lidar_violin.png",
            "intersection-v0 Performance Test - 100 Episodes (LidarObservation)"
        )
    ...
    if os.path.exists("models/intersection_grayscale.zip") and os.path.exists("training_data/intersection_grayscale_training.json"):
        # Plot learning curve
        print("\n1. Generating learning curve...")
        plot_learning_curve(
            "training_data/intersection_grayscale_training.json",
            "plots/intersection_grayscale_learning_curve.png",
            "intersection-v0 Learning Curve (GrayscaleObservation)"
        )
        
        # Evaluate model
        print("\n2. Evaluating trained model...")
        model_grayscale = PPO.load("models/intersection_grayscale")
        eval_rewards_grayscale = evaluate_model(model_grayscale, create_intersection_env_grayscale, n_episodes=100)
        
        # Save evaluation data
        with open("evaluation_data/intersection_grayscale_eval.json", 'w') as f:
            json.dump({
        ...
        plot_violin_performance(
            ...
            "plots/intersection_grayscale_violin.png",
            "intersection-v0 Performance Test - 100 Episodes (GrayscaleObservation)"
        )
    ...
    print("  - intersection_lidar_learning_curve.png")
    print("  - intersection_lidar_violin.png")
    print("  - intersection_grayscale_learning_curve.png")
    print("  - intersection_grayscale_violin.png")
