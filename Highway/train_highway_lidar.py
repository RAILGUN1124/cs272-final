"""
Training script for Highway-v0 environment with LidarObservation
"""
...
def train_highway_lidar(timesteps=100000, model_name="highway_lidar"):
    """
    Train PPO agent on Highway-v0 with LidarObservation
    ...
    """
    print("=" * 60)
    print("Training Highway-v0 with LidarObservation")
    print("=" * 60)
...
if __name__ == "__main__":
    # Train the model
    model, callback = train_highway_lidar(timesteps=100000, model_name="highway_lidar")
